...
class PensionSchema(CamelCaseSchema):
    ...
    status = fields.String(required=False, missing="Validated")  # Ajout du champ status comme optionnel avec une valeur par défaut
...
class PensionDetailSchema(CamelCaseSchema):
    ...
    status = fields.String(required=False, missing="Validated")
