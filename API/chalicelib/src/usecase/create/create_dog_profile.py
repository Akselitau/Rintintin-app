...
def create_dog_profile_handler(data, dog_repo=None):
    ...
    profile_photo_url = data.get('profile_photo_url')  # Utilisez l'URL ici
    information = data.get('information')
    birthdate = data.get('birthdate')

    if not all([user_id, name, breed, profile_photo_url]):
    ...
    print(f"Created dog profile with id: {dog_id}")
    return Response(
