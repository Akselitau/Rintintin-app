    ...
    <div className={`search-bar-container ${withMarginTop ? 'margin-top' : ''}`}>
      <div className="search-bar">
        <div className="search-input-container">
          <label htmlFor="location" style={{ marginRight: '8px' }}>Où ?</label>
          <input
            id="location"
            type="text"
        ...
        <div className="separator"></div>
        <div className="search-input-container">
          <label htmlFor="dogs-count" style={{ marginRight: '8px' }}>Pour</label>
          <input id="dogs-count" type="number" placeholder="Nombre de chiens" className="search-input" />
        </div>
